...
void test_b_ProcuraCaixa() {
	...
	maquina.addCaixa( cx );
	cout << "Carga livre em C" << c1.getID() << ": " << c1.getCargaLivre() << endl;
	cout << "Carga livre em C" << c2.getID() << ": " << c2.getCargaLivre() << endl;
	cout << "Carga livre em C" << cx.getID() << ": " << cx.getCargaLivre() << endl;
	cout << maquina.getCaixas().top().getID() << endl;
...
void runSuite(){
	...
	cute::makeRunner(lis)(s, "AEDA 2018/2019 - Aula Pratica 11");
}
